...
function shouldReportInBackground() {
    ...
    if (localStorage && localStorage.getItem && localStorage.setItem) {
        ...
        if (isNaN(parseInt(flag, 10))) {
            ...
            var confirmmsg = '¿Desea reportar errores Automáticamente? Al reportarlos nos ayuda a hacer una mejor applicación para usted. ' +
                                'Puede cambiar esta configuración en su app cuando desee.';
